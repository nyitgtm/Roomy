                ...
                >
                    ...
                    <div className="flex justify-center mt-5">
                        <button 
                            ...
                            onClick={() => {
                                const facultyId = (document.getElementById('facultyId') as HTMLInputElement).value;
                                const password = (document.getElementById('password') as HTMLInputElement).value;
                                if (facultyId && password) {
                                    //window.location.href = '/faculty/create-account';
                                    alert('Created account for ' + facultyId);
                                } else {
